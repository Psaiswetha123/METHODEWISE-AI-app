...
const PRODUCTION_TIMELINE_STEPS = [
  ...
  { title: 'Quality Inspection', desc: 'CMM & surface Ra check', status: 'Upcoming', icon: 'shield-check' },
  { title: 'Packaging', desc: 'ESD & protective box', status: 'Upcoming', icon: 'package' },
